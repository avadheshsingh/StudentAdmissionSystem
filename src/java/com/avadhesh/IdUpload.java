...
public class IdUpload extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // response.setContentType("text/html;charset=UTF-8");
		...
		// obtains the upload file part in this multipart request
                        ...
                        Part id_Part = request.getPart("id");
                        
			
                      pic_inputStream = id_Part.getInputStream();
		...
		try {
			...
			String sql = "update img set id=? where userid=?";
			...
			if (row > 0) {
				message = "Id Proof uploaded and saved into database";
			}
                        }else{
